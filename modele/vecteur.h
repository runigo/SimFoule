...
/*
	...
	Dans SimFoule, la coordonée z est un entier et représente l'étage.
		Si z est négatif, le mobile est sortie du batiment.

	Les fonctions 2D ne prennent donc pas en compte la coordonnées z.
*/
...
float vecteurNormaliseCartesien2D(vecteurT * v); // normalise, renvoie la norme initiale EN 2 D
float vecteurNormeCartesien2D(vecteurT * v); // Renvoie la norme EN 2 D
