...
struct EtageT {
	celluleT cellule[BATIMENT_X_MAX][BATIMENT_Y_MAX];	//	Un étage est un tableau de cellules

	int etageX;	//	Nombre de cellule suivant x
	int etageY;	//	Nombre de cellule suivant y

	int etage; // Numéro de l'étage

	vecteurT angle[8];	// Vecteurs directions
				//						    6
				//	possibles			 5     7
				//	pour les			4       0
				//	cellules.			 3     1
