...
%      PANNEAU  MASSE
%
  \begin{scope}[xshift=22.7 cm,yshift=23.5cm]
  \fill[panneaucontroles] (-2.3,-4.5) rectangle (5.1,5.9);
    ...
    \node[scale=\scl] at (3.5,-1.85) {\Large{Uniforme}};
    \fill[petitbouton] (3.5,-2.5) circle (0.3cm);
  \end{scope}

%        Boutons rotatifs
  \begin{scope}[xshift=22.7 cm,yshift=25.9cm,scale=0.75]
    \node[scale=\scl] at (0,3.6) {\LARGE \textbf{Masse}};
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{moyenne}};
  ...
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=21.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{Ecart type}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
...
%      PANNEAU  NERVOSITÉ
%
  \fill[panneaucontroles] (20.1,7.3) rectangle (27.6,18.5);
  ...
  \begin{scope}[xshift=22.7 cm,yshift=14.9cm,scale=0.75]
    \node[scale=\scl] at (0,3.6) {\LARGE \textbf{Nervosité}};
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{moyenne}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    ...
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=10.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{Ecart type}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
...
%      PANNEAU  DIVERS
%
  \fill[panneaucontroles] (20.2,1.1) rectangle (27.5,5.8);
 % \fill[panneaucontroles] (20,13) rectangle (27,19.5);
  \begin{scope}[xshift=26.2 cm,yshift=2.0cm]
    ...
    \node[scale=\scl] at (0,2.0) {\Large{.}};
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=3.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE \textbf{.}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
