...
%
  ...
  \fill[panneaucontroles] (-2.3,-4.0) rectangle (5.1,4.9);
   ...
   % \fill[petitbouton] (3.5,1.7) circle (0.3cm);
    \node[scale=\scl] at (3.5,-0.7) {\Large{Uniforme}};
    \fill[petitbouton] (3.5,-1.4) circle (0.3cm);
    \node[scale=\scl] at (3.5,-2.4) {\Large{Aléatoire}};%\acute{e}
    \fill[petitbouton] (3.5,-3.1) circle (0.3cm);
  \end{scope}

%        Boutons rotatifs
  \begin{scope}[xshift=22.7 cm,yshift=26.5cm,scale=0.65]
    \node[scale=\scl] at (0,3.6) {\LARGE{Masse}};% \textbf
    \node[scale=\scl] at (0,2.6) {\LARGE{moyenne}};
  ...
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=22.3cm,scale=0.65]
    \node[scale=\scl] at (0,2.6) {\LARGE{Ecart type}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
...
%
  ...
  \begin{scope}[xshift=22.7 cm,yshift=16.9cm,scale=0.65]
    \node[scale=\scl] at (0,3.6) {\LARGE{Nervosité}};
    \node[scale=\scl] at (0,2.6) {\LARGE{moyenne}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    ...
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=12.8cm,scale=0.65]
    \node[scale=\scl] at (0,2.6) {\LARGE{Ecart type}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
...
%
  ...
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=3.3cm,scale=0.65]
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    ...
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=7.3cm,scale=0.65]
    \node[scale=\scl] at (0,2.7) {\LARGE {Simulation}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
