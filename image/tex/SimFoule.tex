...
%
%   2
  \begin{scope}[xshift=\positionX cm,yshift=8.9 cm]
    % Draw axes
...
%
  ...
  \fill[panneaucontroles] (-2.5,-2) rectangle (5.6,5.7);
...
%        Boutons rotatifs
  \begin{scope}[xshift=22.7 cm,yshift=25.1cm]
    \node[scale=\scl] at (0,2.5) {\LARGE \textbf{Masse}};
...
%
 ...
 % \fill[panneaucontroles] (20,13) rectangle (27,19.5);
  ...
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=7.9cm,scale=0.75]
