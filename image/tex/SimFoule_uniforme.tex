...
%
  \fill[panneaucontroles] (0.5,0.5) rectangle (38.5,5.1);
%
%
%       Réinitialisation
...
%      PANNEAU  DROIT
%
\begin{scope}[xshift=19.9 cm,yshift=0.0cm]
%
%      PANNEAU  MASSE
%
  \begin{scope}[xshift=22.7 cm,yshift=24.5cm]
  \fill[panneaucontroles] (-2.3,-13.9) rectangle (5.1,4.9);
   % \node[scale=\scl] at (3.5,2.4) {\Large{Extrémité}};
   % \fill[petitbouton] (3.5,1.7) circle (0.3cm);
    \node[scale=\scl] at (3.5,-0.7) {\Large{.}};
    \fill[petitbouton] (3.5,-1.4) circle (0.3cm);
    \node[scale=\scl] at (3.5,-2.4) {\Large{.e}};%\acute{e}
    \fill[petitbouton] (3.5,-3.1) circle (0.3cm);
  \end{scope}

%        Boutons rotatifs
  \begin{scope}[xshift=22.7 cm,yshift=26.5cm,scale=0.75]
   % \node[scale=\scl] at (0,3.6) {\LARGE{}};% \textbf
    \node[scale=\scl] at (0,2.6) {\LARGE \bf{Masse}};
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    \foreach \i/\j in {15/7, 45/6, 75/5, 105/4, 135/3, 165/2, 195/1, 225/m, 255/, 285/, 315/M, 345/8} \node[scale=\scl,black] at (\i:1.7) {\j};
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=22.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE \bf{Célérité}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
...
%      PANNEAU  NERVOSITÉ
%
  \begin{scope}[xshift=22.7 cm,yshift=15.1cm]
  %\fill[panneaucontroles] (-2.3,-4.0) rectangle (5.1,4.9);
   ...
   % \node[scale=\scl] at (3.5,2.95) {\Large{Marche}};
    \node[scale=\scl] at (3.5,-0.7) {\Large{.}};
    \fill[petitbouton] (3.5,-1.4) circle (0.3cm);
    \node[scale=\scl] at (3.5,-2.4) {\Large{.}};%\acute{e}
    \fill[petitbouton] (3.5,-3.1) circle (0.3cm);
  \end{scope}

  \begin{scope}[xshift=22.7 cm,yshift=16.9cm,scale=0.75]
  %  \node[scale=\scl] at (0,3.6) {\LARGE{}};
    \node[scale=\scl] at (0,2.6) {\LARGE \bf{Nervosité}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    ...
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=12.8cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE \bf{.}};%Grégarité
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
...
%      PANNEAU  SIMULATION
%
  \begin{scope}[xshift=22.7 cm,yshift=5.0cm]
  \fill[panneaucontroles] (-2.3,-4.0) rectangle (5.1,4.9);
    \fill[petitbouton] (3.5,-0.9) circle (0.3cm);
    \node[scale=\scl] at (3.5,-0.2) {\Large{Implicite}};
    \fill[petitbouton] (3.5,0.9) circle (0.3cm);
    \node[scale=\scl] at (3.5,1.6) {\Large{Max}};
    \fill[petitbouton] (3.5,2.6) circle (0.3cm);
    \node[scale=\scl] at (3.5,3.3) {\Large{Pause}};
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=3.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.6) {\LARGE {.}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
  ...
  %  \foreach \i in {30,60,...,330} \draw[thick] (\i:1.2)--(\i:2.5);
    ...
    \fill[blue!30!black!60!,draw=black,thick] (0,0) circle (0.8cm);
  \end{scope}
  \begin{scope}[xshift=22.7 cm,yshift=7.3cm,scale=0.75]
    \node[scale=\scl] at (0,2.7) {\LARGE  \bf{Simulation}};
    \clip[rounded corners] (-2,-2) rectangle (2,2);
    \fill[black!30!,rounded corners,draw=black,thick] (-2,-2) rectangle (2,2);
    \draw[very thick,rounded corners](-2,-2) rectangle (2,2);
    \draw[thick] (0,0) circle (1.0);
